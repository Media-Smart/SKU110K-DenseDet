...
train_pipeline = [
    ...
    dict(type='UniformRandomCrop', crop_size=(1100,1100)),
...
test_set = dict(
        type=dataset_type,
        ann_file='/DATA/home/tianzerong/sku/SKU_COCO_test.json',
        img_prefix='/DATA/data/SKU110K_fixed/images/',
        pipeline=train_pipeline)
data = dict(
    imgs_per_gpu=1,
    ...
    val=dict(
        type=dataset_type,
        ann_file='/DATA/home/tianzerong/sku/SKU_COCO_train_val.json',
        img_prefix='/DATA/data/SKU110K_fixed/images/',
...
log_level = 'INFO'
work_dir = './work_dirs/SKU_fusion_bifpn_x101_train_test'
load_from = None
resume_from = None
workflow = [('train', 1)]
